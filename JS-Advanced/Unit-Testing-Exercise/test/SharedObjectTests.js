let sharedObject = require('../SharedObject-05').sharedObject;
let expect = require('chai').expect;
let $ = require('jquery');

describe("Shared Object", function () {
    describe("Name", function () {
        it("name variable should be null", function () {
            expect(sharedObject.name).to.equal(null, "Function did not return the correct result!");
        });
    });

    describe("Income", function () {
        it("income variable should be null", function () {
